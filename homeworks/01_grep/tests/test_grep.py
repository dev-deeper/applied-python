...
class GrepContextMyTests2(TestCase):
    ...
    def test_context2_13(self):
        params = grep.parse_args(['bbb', '-C2', '-n'])
        grep.grep(self.lines, params)
        self.assertEqual(lst, ['1-vr', '2-baab', '3:abbb', '4-fc', '5-fc', '6-fc', '7:bbb', '8-cc', '9-cc'])

    def test_context2_14(self):
        params = grep.parse_args(['bbb', '-C1', '-n'])
        grep.grep(self.lines, params)
        self.assertEqual(lst, ['2-baab', '3:abbb', '4-fc', '--', '6-fc', '7:bbb', '8-cc'])

    def test_context2_15(self):
        params = grep.parse_args(['bbb', '-C1', '-n' , '-B2'])
        grep.grep(self.lines, params)
        self.assertEqual(lst, ['1-vr', '2-baab', '3:abbb', '4-fc', '5-fc', '6-fc', '7:bbb', '8-cc'])

    def test_context2_16(self):
        params = grep.parse_args(['bbb', '-C1', '-n' , '-A2'])
        grep.grep(self.lines, params)
        self.assertEqual(lst, ['2-baab', '3:abbb', '4-fc', '5-fc', '6-fc', '7:bbb', '8-cc', '9-cc'])

    def test_context2_17(self):
        params = grep.parse_args(['???', '-B1', '-n' , '-A2'])
        grep.grep(self.lines, params)
        self.assertEqual(lst, ['1-vr', '2:baab', '3:abbb', '4-fc', '5-fc', '6-fc', '7:bbb', '8-cc', '9-cc'])
